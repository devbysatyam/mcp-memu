...
from mcp_memu.utils.adb_helpers import adb_pull, adb_push
...
def register_tools(mcp):
    ...
    def execute_shell(vm_index: int, command: str) -> str:
        ...
        """
        try:
            # Use memuc_run with execcmd directly — execute_command_vm wraps
            # commands in sh -c which breaks multi-word commands like getprop
